...
public class TwoFragmentAndActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TwoTabLayoutUtils tabLayoutUtils = new TwoTabLayoutUtils();
...
//       调用 addFuntion是把对应的哪种通信添加到对应的map容器里
        baseFragment.setFuntionManager(funtionManager.addFuntion(new FuntionNoParamsNoResult(TesFragment.NAME_FLAG) {
            @Override
            public void funtion() {
                Toast.makeText(TwoFragmentAndActivity.this, "成功调用无参数无返回值接口", Toast.LENGTH_SHORT).show();
            }
            ...
            public void funtion(String data) {
                Toast.makeText(TwoFragmentAndActivity.this, data, Toast.LENGTH_SHORT).show();
            }
